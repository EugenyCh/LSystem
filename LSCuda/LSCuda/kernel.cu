...
static int numIterations = 3;	 // current # of iterations to draw system
float zoom = 1.0f;
...
int main(int argc, char* argv[])
{
    ...
    lsystem.width0 = 1.0f;
    lsystem.width1 = 1.0f;
    lsystem.color0[0] = 1.0f;
    lsystem.color0[1] = 1.0f;
    lsystem.color0[2] = 1.0f;
    lsystem.color0[3] = 1.0f;
    lsystem.color1[0] = 1.0f;
    lsystem.color1[1] = 1.0f;
    lsystem.color1[2] = 1.0f;
    lsystem.color1[3] = 1.0f;
    lsystem.setInitialString("X");
    lsystem.addRule('X', "^\\XF^\\XFX-F^//XFX&F+//XFX-F/X-/");
    lsystem.setAngle(M_PI / 2);
    lsystem.setDistScale(1.0f);
